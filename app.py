...
def init_supabase() -> Client:
    ...
    Conexión directa a tu instancia de Supabase.
    """
    MAX_RETRIES = 3
    for attempt in range(MAX_RETRIES):
        try:
            ...
            key = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imt3c3VzemtibGJlanZsaW5pZ2dkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzQ2MjU0MzMsImV4cCI6MjA1MDIwMTQzM30.DpWyb9LfXqiZBlmuSWfgIw_O2-LDm2b"
                
            if not url or not key:
                st.error("Error: Las credenciales de Supabase (url y key) no están configuradas.")
                return None
...
with col_data:
    ...
    if st.button("🔄 Actualizar Datos Históricos", help="Recarga la tabla y gráficos desde Supabase."):
        ...
        st.rerun() # Fuerza un rerun para mostrar los datos actualizados
